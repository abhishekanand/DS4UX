...
highest_Hour = no_edit_in_hour.index(max(no_edit_in_hour))
Number_of_edits_highest_hour = max(no_edit_in_hour)

print('Between '+ str(highest_Hour)+ ':00 PM to ' + str(highest_Hour + 1)+':00 PM we had ' + str(Number_of_edits_highest_hour) + ' edits which the highest number of edits')
